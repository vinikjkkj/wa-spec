...
export declare const WA_APPSTATE_SCHEMAS: {
    ...
    readonly MarketingMessage: WaAppstateSchema<'marketingMessage', 'regular', 'account', 'marketingMessageAction', 'SyncActionValue.MarketingMessageAction', null, readonly [{ readonly type: 'literal'; readonly value: 'marketingMessage' }, { readonly type: 'string'; readonly name: 'id' }]>
    ...
    readonly StatusPrivacy: WaAppstateSchema<'status_privacy', 'regular_high', 'account', 'statusPrivacy', 'SyncActionValue.StatusPrivacyAction', null, readonly [{ readonly type: 'literal'; readonly value: 'status_privacy' }]>
