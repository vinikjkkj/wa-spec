...
export declare const WA_APPSTATE_SCHEMAS: {
    ...
    readonly CallLog: WaAppstateSchema<'call_log', 'regular', 'account', 'callLogAction', 'SyncActionValue.CallLogAction', { readonly 'callLogRecord.callResult': 'CallLogRecord.CallResult'; readonly 'callLogRecord.callType': 'CallLogRecord.CallType'; readonly 'callLogRecord.participants.callResult': 'CallLogRecord.CallResult'; readonly 'callLogRecord.silenceReason': 'CallLogRecord.SilenceReason' }, readonly [{ readonly type: 'literal'; readonly value: 'call_log' }, { readonly type: 'string'; readonly name: 'key1' }, { readonly type: 'string'; readonly name: 'callId' }, { readonly type: 'string'; readonly name: 'fromMe' }]>
    ...
    readonly DeviceCapabilities: WaAppstateSchema<'device_capabilities', 'regular_low', 'account', 'deviceCapabilities', 'DeviceCapabilities', null, readonly [{ readonly type: 'literal'; readonly value: 'device_capabilities' }, { readonly type: 'string'; readonly name: 'jid' }]>
    readonly DeviceCapabilitiesV2: WaAppstateSchema<'device_capabilities_v2', 'regular_low', 'account', 'deviceCapabilitiesV2', 'DeviceCapabilities', null, readonly [{ readonly type: 'literal'; readonly value: 'device_capabilities_v2' }, { readonly type: 'string'; readonly name: 'jid' }]>
    ...
    readonly Sentinel: WaAppstateSchema<'sentinel', 'regular_low', 'account', 'keyExpiration', 'SyncActionValue.KeyExpiration', null, readonly [{ readonly type: 'literal'; readonly value: 'sentinel' }, { readonly type: 'string'; readonly name: 'collection' }]>
    ...
    readonly SettingsSync: WaAppstateSchema<'settings_sync', 'regular_low', 'account', 'settingsSyncAction', 'SyncActionValue.SettingsSyncAction', { readonly 'bannerNotificationDisplayMode': 'SettingsSyncAction.DisplayMode'; readonly 'mediaUploadQuality': 'SettingsSyncAction.MediaQualitySetting'; readonly 'unreadCounterBadgeDisplayMode': 'SettingsSyncAction.DisplayMode' }, readonly [{ readonly type: 'literal'; readonly value: 'settings_sync' }, { readonly type: 'enum'; readonly name: 'settingPlatform'; readonly protoEnum: 'SettingsSyncAction.SettingPlatform' }, { readonly type: 'enum'; readonly name: 'settingKey'; readonly protoEnum: 'SettingsSyncAction.SettingKey' }, { readonly type: 'jid'; readonly name: 'chatJid' }]>
